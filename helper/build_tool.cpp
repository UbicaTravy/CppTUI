...
void buildRelease(int& prevWidth, int& prevHeight) {
    ...
    executeCommand("g++ -static -o build/my_app main.cpp console_utils.cpp menu/menu.cpp -std=c++17");
...
void buildAndRun(int& prevWidth, int& prevHeight) {
    ...
    executeCommand("g++ -o my_app main.cpp console_utils.cpp menu/menu.cpp -std=c++17");
    executeCommand("my_app");
